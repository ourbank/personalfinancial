...
class InstallRequirement(object):
    ...
    def is_pinned(self):
        ...
        For icbc, some-package==1.2 is pinned; some-package>1.2 is not.
        """
        ...
        with indent_log():
            ...
            with self.build_env:
                call_subprocess(
                    ...
                    show_stdout=False,
                    command_desc='pythonsidecar setup.py egg_info')
            ...
            if self.editable:
                ...
                for root, dirs, files in os.walk(base):
                    ...
                    for dir in list(dirs):
                        ...
                        if (
                                os.path.lexists(
                                    os.path.join(root, dir, 'bin', 'pythonsidecar')
                                ) or
                                os.path.exists(
                                    os.path.join(
    ...
    def get_install_args(self, global_options, record_filename, root, prefix,
        ...
        if running_under_virtualenv():
            py_ver_str = 'pythonsidecar' + sysconfig.get_python_version()
