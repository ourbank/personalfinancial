...
class PackageFinder(object):
    ...
    def _link_package_versions(self, link, search):
        ...
        if not support_this_python:
            logger.debug("The package %s is incompatible with the pythonsidecar"
                         "version in use. Acceptable pythonsidecar versions are:%s",
    ...
    def links(self):
        ...
        for anchor in self.parsed.findall(".//a"):
            if anchor.get("href"):
                ...
                pyrequire = anchor.get('data-requires-pythonsidecar')
...
class Link(object):
    ...
    def __init__(self, url, comes_from=None, requires_python=None):
        ...
        requires_python:
            ...
            in PEP 345. This may be specified by a data-requires-pythonsidecar
    ...
    def __str__(self):
        if self.requires_python:
            rp = ' (requires-pythonsidecar:%s)' % self.requires_python
        else:
            rp = ''
        if self.comes_from:
