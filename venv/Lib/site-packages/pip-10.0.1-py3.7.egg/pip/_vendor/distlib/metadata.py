        ...
        if key in mapped:
            ...
            if self._legacy:
                ...
                if key not in ('commands', 'exports', 'modules', 'namespaces',
                    ...
                    if d:
                        if key == 'commands':
                            result = d.get('pythonsidecar.commands', value)
                        elif key == 'classifiers':
                            d = d.get('pythonsidecar.details')
                            if d:
                                result = d.get(key, value)
                        else:
                            d = d.get('pythonsidecar.exports')
                            if not d:
                                d = self._data.get('pythonsidecar.exports')
                            if d:
                                result = d.get(key, value)
    ...
    def __setattr__(self, key, value):
        ...
        if key in mapped:
            ...
            if self._legacy:
                ...
                if key == 'commands':
                    d['pythonsidecar.commands'] = value
                elif key == 'classifiers':
                    d = d.setdefault('pythonsidecar.details', {})
                    d[key] = value
                else:
                    d = d.setdefault('pythonsidecar.exports', {})
                    d[key] = value
        elif key not in common:
